...
define([
  ...
  return declare([BaseWidget, Evented], {
    ...
    _createPrintMapParameters: function (mapParams) {
      ...
      // This is to workaround the fact that the print service will add the page size as the title if its not user defined
      // We add a custom element to the top of the report to support the title
      if (!printTemplate.hasOwnProperty('layoutOptions')) {
        printTemplate.layoutOptions = {};
      }
      printTemplate.layoutOptions.titleText = " ";
