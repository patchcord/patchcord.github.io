  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate, dojoEvented], {
    ...
    */
    ...
    postCreate: function () {
      ...
      this._fetchPortalGeomSrvcUrl().then(dojoLang.hitch(this, function (geomsrvcUrl) {
        ...
        if (dojoLang.trim(geomsrvcUrl) === "") {
          geomsrvcUrl = this.parentWidget.appConfig.geometryService;
        }
    ...
    _fetchPortalGeomSrvcUrl: function () {
      ...
      if (this.parentWidget.appConfig.portalUrl && dojoLang.trim(this.parentWidget.appConfig.portalUrl) !== "") {
        //get portal info to fetch geometry service Url
        portalUtils.getPortalSelfInfo(this.parentWidget.appConfig.portalUrl).then(dojoLang.hitch(
          this,
          function (portalInfo) {
